...
public class CrudAlumnoServlet extends HttpServlet {
	...
	private void inserta(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String vfecNac = req.getParameter("fechaNacimiento");
		...
		objAlumno.setFechaNacimiento(Date.valueOf(vfecNac));
	...
	private void actualiza(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Respuesta objRespuesta = new Respuesta();
		if (insertados > 0) {
			objRespuesta.setMensaje("Alumno actualizado exitosamente");
		} else {
			objRespuesta.setMensaje("Error en la actualizacion");
		}
		objRespuesta.setDatos(lista);
	...
	private void eliminacionLogica(HttpServletRequest req, HttpServletResponse resp)
	...
	private void eliminacionFisica(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
