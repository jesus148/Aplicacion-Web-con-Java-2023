			                   		...
			                   		<div id="stepOne" class="panel-collapse collapse in">
			                   			...
			                   			<div class="panel-body">
		                                    ...
		                                    <div class="form-group" >
		                                        ...
		                                        <div class="col-lg-8">
													<input class="form-control" id="id_reg_telefono" name="telefono" placeholder="Ingrese el telefono" maxlength="9"/>
		                                        </div>
		                                    </div> 
			                                <div class="form-group">
			                   		...
			                   		<div id="stepOne" class="panel-collapse collapse in">
			                   			...
			                   			<div class="panel-body">
		                                    ...
		                                    <div class="form-group" >
		                                        ...
		                                        <div class="col-lg-8">
													<input class="form-control" id="id_act_telefono" name="telefono" placeholder="Ingrese el telefono" maxlength="9"/>
		                                        </div>
		                                    </div>  	
		                                    <div class="form-group">
...
<script type="text/javascript">
		...
		function verFormularioActualiza(idAutor, nombre, apellido ,fechaNacimiento ,telefono, estado, grado){
