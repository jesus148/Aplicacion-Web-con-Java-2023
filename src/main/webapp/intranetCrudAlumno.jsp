			                   ...
			                   <div class="panel panel-default">
			                   		<div id="stepOne" class="panel-collapse collapse in">
			                   			...
			                   			<div class="panel-body">
		                                    ...
		                                    <div class="form-group">
												<label class="col-lg-3 control-label" for="id__reg_telefono">Teléfono</label>
												<div class="col-lg-8">
													<input class="form-control" type="text" id="id__reg_telefono" name="telefono" placeholder="Ingrese el teléfono">
												</div>
											</div>
											<div class="form-group">
			                   ...
			                   <div class="panel panel-default">
			                   		<div id="stepOne" class="panel-collapse collapse in">
			                   			...
			                   			<div class="panel-body">
		                                    ...
		                                    <div class="form-group">
												<label class="col-lg-3 control-label" for="id__act_telefono">Teléfono</label>
												<div class="col-lg-8">
													<input class="form-control" type="text" id="id__act_telefono" name="telefono" placeholder="Ingrese el teléfono">
												</div>
											</div>
											<div class="form-group">
