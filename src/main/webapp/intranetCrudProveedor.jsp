...
<h4>Crud Proveedor</h4>
		...
		<div class="row" style="margin-top: 5%">
			...
			<div class="col-md-6">
				<input	class="form-control" type="text" id="id_filtro" placeholder="Ingrese Razón Social">
			</div>	
			<div class="col-md-1">
			                   ...
			                   <div class="panel panel-default">
			                   		<div id="stepOne" class="panel-collapse collapse in">
			                               ...
			                               <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_razon">Razón Social</label>
		                                        <div class="col-lg-8">
													<input class="form-control" id="id_reg_razon" name="razon" placeholder="Ingrese la Razón Social" type="text" maxlength="100"/>
		                                        </div>
		                                    </div> 	
                   							<div class="form-group">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-8">
													<input class="form-control" id="id_reg_direccion" name="direccion" placeholder="Ingrese dirección" type="text" maxlength="150"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
			                   		...
			                   		<div id="stepOne" class="panel-collapse collapse in">
			                   			...
			                   			<div class="panel-body">
											<div class="form-group">
		                                        ...
		                                        <div class="col-lg-8">
													<input class="form-control" id="id_act_razon" name="razon" placeholder="Ingrese Razón Social" type="text" maxlength="100"/>
		                                        </div>
		                                    </div> 	
		                                    <div class="form-group">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-8">
													<input class="form-control" id="id_act_direccion" name="direccion" placeholder="Ingrese dirección" type="text" maxlength="150"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		        	...
		        	direccion : {  
		        		...
		        		validators : {
		                    ...
		                    stringLength: {
		                        min: 3,
		                        max: 50,
		                        message: 'La dirección tiene de 3 a 50 caracteres'
		                    },
		        		}
		        	},
		        	celular : {  
